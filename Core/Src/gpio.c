...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, A10_Pin|A11_Pin|A12_Pin|A13_Pin
                          |A14_Pin|A15_Pin|A8_Pin|A9_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ENTER_Pin|DOWN_Pin|LEFT_Pin|RIGHT_Pin;
